...
(function (window, undefined) {
    ...
    jQuery.support = (function () {
        ...
        jQuery(function () {
            ...
            style =
                "style='" + positionTopLeftWidthHeight + paddingMarginBorder + "5px solid #000;";
            html =
                "<div " +
                style +
            ...
            if (window.getComputedStyle) {
                ...
                support.pixelMargin =
                    (window.getComputedStyle(div, null) || { marginTop: 0 }).marginTop !== "1%";
            }
    ...
    jQuery.event = {
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            for (i = 0; i < eventPath.length && !event.isPropagationStopped(); i++) {
                ...
                handle =
                    (jQuery._data(cur, "events") || {})[event.type] && jQuery._data(cur, "handle");
                if (handle) {
            ...
            if (speed || speed === 0) {
                ...
                for (var i = 0, j = this.length; i < j; i++) {
                    ...
                    if (elem.style) {
                        ...
                        // for such an element
                        if (
                            (display === "" && jQuery.css(elem, "display") === "none") ||

        ...
        <main className="bg-theme-primary min-h-screen">
            ...
            <section className="relative pt-32 pb-20 text-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 animate-fade-in-up">
                    ...
                    <h1 className="font-serif text-5xl md:text-7xl font-black mb-6 leading-tight text-theme-primary">
                        Born from <span className="text-transparent bg-clip-text bg-gradient-to-r from-espresso via-terracotta to-espresso dark:from-ivory dark:via-gold dark:to-ivory animate-shine">Purpose</span>
                    </h1>
            ...
            <Section>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div className="space-y-6 animate-slide-in-left">
                        <span className="text-theme-accent font-bold uppercase tracking-[0.2em] text-sm">The Beginning</span>
            ...
            <Section className="bg-theme-secondary">
                <div className="text-center mb-16">
                    <span className="text-theme-accent font-bold uppercase tracking-[0.2em] text-sm">Our Principles</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                        ...
                        >
                            ...
                            <h3 className="text-xl font-serif font-bold mb-3 text-theme-primary">{value.title}</h3>
            ...
            <Section>
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    <span className="text-theme-accent font-bold uppercase tracking-[0.2em] text-sm">Our Mission</span>
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-theme-primary">
                        Food You Can Trust
                    </h2>
                    ...
                    <p className="text-xl text-theme-secondary leading-relaxed">
                        Amrit Milk Organic isn't just a dairy brand. It's a movement to restore what industrial agriculture stole: the right to real food.
                    </p>

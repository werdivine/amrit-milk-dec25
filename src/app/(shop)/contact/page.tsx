        ...
        <main className="bg-theme-primary min-h-screen">
            ...
            <section className="relative py-32 flex items-center justify-center">
                ...
                <div className="relative z-10 text-center max-w-4xl px-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-serif font-bold text-theme-primary mb-6">
                        Get in Touch
                    </h1>
                    <p className="text-xl text-theme-secondary text-white/80 max-w-2xl mx-auto">
                        Questions about subscriptions? Want to schedule a farm visit? We&apos;re
                        here to help.
                    </p>
                </div>
            </section>
                    ...
                    <div className="space-y-6">
                        <div className="glass-theme p-8 rounded-3xl">
                            ...
                            <p className="text-theme-muted text-sm">
                                Farm visits available every Sunday for subscribers. Book via
                                WhatsApp at least 48 hours in advance.
                            </p>
                        </div>

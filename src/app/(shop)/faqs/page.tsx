        ...
        <main className="bg-creme dark:bg-midnight min-h-screen transition-colors duration-500">
            ...
            <section className="relative py-32 flex items-center justify-center">
                ...
                <div className="relative z-10 text-center max-w-4xl px-6">
                    ...
                    <p className="text-xl text-espresso-light dark:text-ivory/80 max-w-2xl mx-auto mb-8">
                        Everything you need to know about Amrit Milk, our farm, and your
                        subscription.
                    </p>
            ...
            {searchQuery && (
                <Section className="pt-0">
                    <div className="max-w-4xl mx-auto">
                        <p className="text-espresso-light dark:text-ivory/80 mb-6">
                        ...
                        {filteredFaqs.length > 0 ? (
                            <div className="space-y-4">
                                {filteredFaqs.map((faq) => (
                                    <div
                                        key={faq.key}
                                        className="bg-white dark:bg-midnight-mid border border-creme-dark dark:border-white/5 p-6 rounded-2xl shadow-soft dark:shadow-card-dark"
                                    >
                                        <h3 className="text-lg font-bold text-espresso dark:text-ivory mb-3">
                                            {faq.question}
                                        </h3>
                            ...
                            <p className="text-espresso-muted dark:text-ivory/60 text-center py-12">
            ...
            {!searchQuery && (
                <>
                    ...
                    <Section>
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-2xl font-bold text-espresso dark:text-ivory mb-8">
                            ...
                            <div className="space-y-4">
                                {faqCategories[activeCategory].faqs.map((faq, index) => {
                                    ...
                                    return (
                                        <div
                                            key={key}
                                            className="bg-white dark:bg-midnight-mid border border-creme-dark dark:border-white/5 rounded-2xl overflow-hidden shadow-soft dark:shadow-card-dark"
                                        >
                                            <button
                                                className="w-full px-6 py-5 flex items-center justify-between text-left"
                                                onClick={() => toggleItem(key)}
                                            >
                                                <span className="text-lg font-medium text-espresso dark:text-ivory pr-4">
                                                    {faq.question}
                                                </span>
                                                <ChevronDown
                                            ...
                                            >
                                                <p className="px-6 pb-5 text-espresso-light dark:text-ivory/80 leading-relaxed">
                                                    {faq.answer}
                                                </p>
                                            </div>
                                        </div>

...
const cowBreeds = [
    {
        ...
        description:
            "The Gir is the most famous indigenous breed, known for producing the highest-quality A2 milk. Our herd consists exclusively of purebred Gir cows.",
    ...
    },
    {
        ...
        description:
            "Sahiwal cattle are one of the best milch breeds and are known for their heat tolerance and tick resistance.",
    ...
    },
    {
        ...
        description:
            "Known for their hardiness and adaptability to tropical conditions while maintaining excellent milk quality.",
        ...
        <main className="bg-creme dark:bg-midnight min-h-screen transition-colors duration-500">
            ...
            <section className="relative h-[60vh] flex items-center justify-center">
                ...
                <div className="relative z-10 text-center max-w-4xl px-6">
                    ...
                    <p className="text-xl text-ivory/70 max-w-2xl mx-auto">
                        Every drop of Amrit Milk comes from verified indigenous breeds. Explore the
                        science behind pure A2 genetics.
                    </p>
                </div>
            </section>
            ...
            <Section>
                <div className="max-w-4xl mx-auto text-center mb-16">
                    ...
                    <h2 className="text-4xl font-serif font-bold text-espresso dark:text-ivory mb-6">
                        A2 vs A1: The Critical Difference
                    </h2>
            ...
            <Section className="bg-creme-light dark:bg-midnight-mid transition-colors duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {cowBreeds.map((breed, index) => (
                        <div
                            key={breed.name}
                            className="bg-white dark:bg-glass-bg border border-creme-dark dark:border-glass-border hover:border-gold/30 shadow-soft dark:shadow-none p-8 rounded-3xl transition-all"
                        >
                            ...
                            <p className="text-espresso-muted dark:text-ivory/50 text-center mb-4">
                                Origin: {breed.origin}
                            </p>
                            <p className="text-espresso-light dark:text-ivory/70 text-center mb-6">
                                {breed.description}
                            </p>
                            ...
                            <div className="grid grid-cols-3 gap-2 text-center border-t border-glass-border pt-6">
                                <div>
                                    ...
                                    <p className="text-espresso-muted dark:text-ivory/50 text-xs">
                                        Daily Yield
                                    </p>
                                </div>
                                <div>
            ...
            <Section className="text-center">
                <h2 className="text-3xl font-serif font-bold text-espresso dark:text-ivory mb-6">
                    Experience Pure A2 Genetics
                </h2>
                <p className="text-espresso-light dark:text-ivory/60 max-w-xl mx-auto mb-8">
                    Join 500+ families who have switched to verified pure A2 milk from our
                    indigenous Gir cow herd.
                </p>
                <Button

            ...
            <main className="bg-creme dark:bg-midnight transition-colors duration-500 min-h-screen">
                <Section>
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-serif font-bold text-espresso dark:text-ivory mb-4">
                            Your Perfect Match!
                        </h1>
                    ...
                    <div className="grid gap-4">
                        {question.options.map((option, i) => (
                            <button
                                ...
                                className="group bg-white dark:bg-white/5 border border-espresso/10 dark:border-white/10 rounded-2xl p-6 text-left hover:border-terracotta/50 dark:hover:border-gold/50 hover:bg-creme dark:hover:bg-gold/5 transition-all duration-300 transform hover:scale-105 animate-fade-in-up shadow-sm hover:shadow-md"

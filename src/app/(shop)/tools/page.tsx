...
import { Calculator, DollarSign, Heart, TrendingUp } from "lucide-react";
            ...
            <section className="pt-32 pb-20 text-center">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6">
                        Smart{" "}
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-espresso via-gold to-espresso dark:from-ivory dark:via-gold dark:to-ivory">
                            Calculators
                        </span>
                    </h1>
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
                ...
                <h2 className="text-4xl font-serif font-bold mb-4 text-espresso dark:text-ivory">
                    Health ROI Calculator
                </h2>
                <p className="text-xl text-espresso-muted dark:text-ivory/60">
                    Calculate the real value of switching to A2 milk
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                    <div className="bg-white dark:bg-midnight-mid border border-creme-dark dark:border-white/5 shadow-soft dark:shadow-card-dark rounded-2xl p-8">
                        <h3 className="text-xl font-bold mb-6 text-espresso dark:text-ivory">
                            Your Details
                        </h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-3 text-espresso-light dark:text-ivory/80">
                                    Family Size:{" "}
                                    <span className="text-gold text-xl ml-2">{familySize}</span>{" "}
                                    people
                                </label>
                                <input
                                    type="range"
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-3 text-espresso-light dark:text-ivory/80">
                                    Current Monthly Milk Spend:{" "}
                                    <span className="text-gold text-xl ml-2">₹{currentSpend}</span>
                                </label>
                                <input
                                    type="range"
                                    min="200"
                ...
                <div className="space-y-6">
                    <div className="bg-gradient-to-br from-gold/20 to-gold/5 border border-gold/30 rounded-2xl p-8 bg-white dark:bg-midnight-mid shadow-soft dark:shadow-card-dark">
                        ...
                        <div className="space-y-6">
                            <div>
                                <p className="text-sm text-espresso-muted dark:text-ivory/60 mb-1">
                                    Monthly A2 Milk Investment
                                </p>
                                <p className="text-3xl font-bold text-gold">
                                    ₹{monthlyA2Cost.toLocaleString()}
                                </p>
                            </div>
                            ...
                            <div>
                                <p className="text-sm text-espresso-muted dark:text-ivory/60 mb-1">
                                    Estimated Health Value
                                </p>
                                <p className="text-2xl font-bold text-green-500">
                                    ₹{healthBenefit.toLocaleString()}/month
                                </p>
                                <p className="text-xs text-espresso-muted dark:text-ivory/60 mt-1">
                                    *Based on reduced inflammation, better digestion, stronger
                                    immunity
                                </p>
                            </div>
                    ...
                    <div className="bg-white dark:bg-midnight-mid border border-creme-dark dark:border-white/5 shadow-soft dark:shadow-card-dark rounded-xl p-6 flex items-start gap-4">
                        ...
                        <p className="text-sm text-espresso-light dark:text-ivory/80 leading-relaxed">
                            <strong>Health Note:</strong> A2 milk is easier to digest, reduces
                            inflammation, and supports gut health. Many families report fewer
                            digestive issues and improved energy within weeks.
                        </p>
                    </div>
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-espresso-muted dark:text-ivory/60">
                    See how much you save with recurring delivery
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="bg-white dark:bg-midnight-mid border border-creme-dark dark:border-white/5 shadow-soft dark:shadow-card-dark rounded-2xl p-8">
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-3 text-espresso-light dark:text-ivory/80">
                            Bottles per Week (500ml):{" "}
                            <span className="text-gold text-2xl ml-2">{weeklyBottles}</span>
                        </label>
                        <input
                            type="range"
                            min="1"
                        ...
                        <p className="text-xs text-espresso-muted dark:text-ivory/60 mt-2">
                            That&apos;s {(weeklyBottles * 0.5).toFixed(1)}L per week, or{" "}
                            {(weeklyBottles * 0.5 * 4).toFixed(0)}L per month
                        </p>
                    </div>
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <div className="flex justify-between items-center pb-3 border-b border-gold/30">
                            <span className="font-bold text-espresso dark:text-ivory">
                                A2 Subscription (₹{subscriptionPrice}/bottle)
                            </span>
                ...
                <div className="space-y-6">
                    <div className="bg-gradient-to-br from-green-500/20 to-green-500/5 border border-green-500/30 rounded-2xl p-8 bg-white dark:bg-transparent shadow-soft dark:shadow-none">
                        <h3 className="text-2xl font-bold mb-6 text-espresso dark:text-ivory">
                            Your Savings
                        </h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-creme-light dark:bg-midnight-mid rounded-xl p-6">
                                <p className="text-sm text-espresso-muted dark:text-ivory/60 mb-2">

        ...
        <main className="bg-midnight min-h-screen">
            ...
            <section className="relative py-32 flex items-center justify-center">
                ...
                <div className="relative z-10 text-center max-w-4xl px-6">
                    <span className="text-gold font-bold uppercase tracking-[0.3em] mb-4 block">ROI Calculator</span>
                    <h1 className="text-5xl md:text-7xl font-serif font-bold text-ivory mb-6">True Cost of Purity</h1>
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="glass p-8 rounded-3xl border border-glass-border">
                            <h2 className="text-2xl font-bold text-ivory mb-8 flex items-center gap-3">
                            ...
                            {/* Family Size */}
                            <div className="mb-8">
                                <label className="block text-ivory/70 mb-3">Family Size</label>
                                <div className="flex items-center gap-4">
                                    <input
                                        ...
                                        className="flex-1 h-2 bg-midnight rounded-lg appearance-none cursor-pointer accent-gold"
                                    />
                                    <span className="text-2xl font-bold text-gold w-12 text-center">{familySize}</span>
                                </div>
                            </div>

                            {/* Daily Consumption */}
                            <div className="mb-8">
                                <label className="block text-ivory/70 mb-3">Daily Milk Consumption (Liters)</label>
                                <div className="flex items-center gap-4">
                                    <input
                                        type="range"
                                        min="0.5"
                                        ...
                                        className="flex-1 h-2 bg-midnight rounded-lg appearance-none cursor-pointer accent-gold"
                                    />
                                    <span className="text-2xl font-bold text-gold w-12 text-center">{dailyConsumption}L</span>
                                </div>
                            </div>

                            {/* Current Milk Type */}
                            <div className="mb-8">
                                <label className="block text-ivory/70 mb-3">Current Milk Type</label>
                                    ...
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`p-4 rounded-xl border text-center transition-all ${currentMilkType === option.value
                                                ...
                                                : 'border-glass-border text-ivory/70 hover:border-ivory/30'
                                                }`}
                                        >
                        ...
                        <div className="space-y-6">
                            {/* Monthly Comparison */}
                            <div className="glass p-8 rounded-3xl border border-glass-border">
                                <h3 className="text-lg font-bold text-ivory/70 mb-6 flex items-center gap-2">
                                    <TrendingUp className="w-5 h-5 text-gold" />
                                    Monthly Comparison
                                </h3>
                                <div className="grid grid-cols-2 gap-6">
                                    <div>
                                        <p className="text-ivory/50 text-sm mb-1">Current Spending</p>
                                        <p className="text-3xl font-bold text-ivory">₹{calculations.currentCost.toLocaleString()}</p>
                                    </div>
                                    <div>
                                        <p className="text-ivory/50 text-sm mb-1">With Amrit</p>
                                        <p className="text-3xl font-bold text-gold">₹{calculations.amritCost.toLocaleString()}</p>
                                    </div>
                                </div>
                                <div className="mt-6 pt-6 border-t border-glass-border">
                                    <p className="text-ivory/50 text-sm mb-1">Additional Investment</p>
                                    <p className={`text-2xl font-bold ${calculations.difference > 0 ? 'text-amber-400' : 'text-green-400'}`}>
                            ...
                            {/* Health ROI */}
                            <div className="glass p-8 rounded-3xl border border-green-500/30">
                            ...
                            {/* Net ROI */}
                            <div className={`glass p-8 rounded-3xl border ${calculations.isNetPositive ? 'border-green-500/30 bg-green-500/5' : 'border-gold/30'}`}>
                                <h3 className="text-lg font-bold text-ivory mb-4 flex items-center gap-2">
                                    <Leaf className="w-5 h-5 text-gold" />
                                    Net Monthly Impact
                                </h3>
                                <p className={`text-4xl font-bold ${calculations.isNetPositive ? 'text-green-400' : 'text-gold'}`}>
                            ...
                            {/* CTA */}
                            <Button href="/subscription-hub" size="lg" className="w-full bg-gold text-midnight hover:bg-white">

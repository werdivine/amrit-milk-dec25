...
export default function SubscriptionHub() {
    return (
        <main className="min-h-screen bg-creme dark:bg-midnight pt-20 transition-colors duration-500">
            <Section className="text-center relative overflow-hidden">
                ...
                <h1 className="text-6xl md:text-7xl font-serif font-bold mb-8 text-espresso dark:text-ivory">The Circle of Health.</h1>
                <p className="text-xl text-espresso-light dark:text-ivory/80 max-w-2xl mx-auto mb-12">

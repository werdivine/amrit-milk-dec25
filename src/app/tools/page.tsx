            ...
            <section className="pt-32 pb-20 text-center">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6">
                        Smart <span className="text-transparent bg-clip-text bg-gradient-to-r from-ivory via-gold to-ivory">Calculators</span>
                    </h1>
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
                ...
                <h2 className="text-4xl font-serif font-bold mb-4">Health ROI Calculator</h2>
                <p className="text-xl text-ivory/60">Calculate the real value of switching to A2 milk</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                {/* Results Section */}
                <div className="space-y-6">
                    <div className="bg-gradient-to-br from-gold/20 to-gold/5 border border-gold/30 rounded-2xl p-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <p className="text-sm text-ivory/60 mb-1">Estimated Health Value</p>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-glass-bg rounded-xl p-4">
                                    ...
                                    <p className="text-xs text-ivory/60">More Protein Daily</p>
                                </div>
                                <div className="bg-glass-bg rounded-xl p-4">
                                    <p className="text-2xl font-bold text-gold">+{omega3Boost}%</p>
                                    <p className="text-xs text-ivory/60">More Omega-3</p>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className="bg-glass-bg border border-glass-border rounded-xl p-6 flex items-start gap-4">
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
                ...
                <h2 className="text-4xl font-serif font-bold mb-4">Subscription Savings Calculator</h2>
                <p className="text-xl text-ivory/60">See how much you save with recurring delivery</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                {/* Input */}
                <div className="bg-glass-bg border border-glass-border rounded-2xl p-8">
                    <h3 className="text-xl font-bold mb-6">Weekly Consumption</h3>
                    ...
                    <div className="mt-8 space-y-4">
                        <div className="flex justify-between items-center pb-3 border-b border-glass-border">
                            ...
                            <span className="text-ivory/60">₹{weeklyRegular}/week</span>
                        </div>
                        <div className="flex justify-between items-center pb-3 border-b border-glass-border">
                            <span>A2 Milk One-Time (₹{a2CurrentPrice}/bottle)</span>
                            <span className="text-ivory/60">₹{weeklyA2}/week</span>
                        </div>
                        <div className="flex justify-between items-center pb-3 border-b border-gold/30">
                            <span className="font-bold">A2 Subscription (₹{subscriptionPrice}/bottle)</span>
                ...
                <div className="space-y-6">
                    <div className="bg-gradient-to-br from-green-500/20 to-green-500/5 border border-green-500/30 rounded-2xl p-8">
                        ...
                        <div className="space-y-6">
                            <div>
                                <p className="text-sm text-ivory/60 mb-1">Monthly Savings</p>
                            ...
                            <div>
                                <p className="text-sm text-ivory/60 mb-1">Yearly Savings</p>
                                <p className="text-3xl font-bold text-green-500">₹{yearlySavings.toLocaleString()}</p>
                            </div>

                            <div className="bg-glass-bg rounded-xl p-6">
                                <p className="text-sm text-ivory/60 mb-2">Subscription Benefits:</p>

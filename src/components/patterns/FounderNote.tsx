        ...
        <Section className="bg-creme dark:bg-midnight transition-colors duration-500">
            <div className="max-w-4xl mx-auto text-center space-y-8">
                ...
                <div className="space-y-6 text-espresso/80 dark:text-ivory/80 text-lg md:text-xl font-light leading-relaxed max-w-3xl mx-auto">
                    <p>
                        Starting Amrit Milk Organic wasn&apos;t a business decision; it was a
                        father&apos;s necessity. I couldn&apos;t find milk in Lucknow that
                        wasn&apos;t contaminated with urea or hormones.
                    </p>
                    <p>
                        I went back to our roots, to the native Gir cows, and built a farm that
                        operates on the principles of Ahimsa and Vedic hygiene.
                    </p>
                    <p className="font-serif italic text-2xl text-espresso dark:text-ivory pt-4 border-t border-espresso/10 dark:border-white/10">
                        &quot;I drink this milk every morning. My children drink it. Only then, does
                        it reach your doorstep.&quot;
                    </p>
                </div>
            </div>
        </Section>

            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                <div className="space-y-8">
                    ...
                    <p className="text-espresso/70 dark:text-ivory/70 text-lg">
                        Switching to Amrit Sovereign isn&apos;t an expense; it&apos;s a reallocation
                        of your pharmacy budget. Pure A2 milk prevents long-term inflammation costs.
                    </p>
                    ...
                    <div className="space-y-6 bg-white dark:bg-midnight p-8 rounded-[2rem] shadow-soft dark:shadow-none border border-espresso/5 dark:border-white/5 transition-colors">
                        <div className="space-y-4">
                            <div className="flex justify-between text-sm font-bold uppercase tracking-widest text-espresso/60 dark:text-ivory/60">
                                ...
                                <span className="text-terracotta dark:text-gold">
                                    {liters} Liters
                                </span>
                            </div>
                            <input
                        ...
                        <div className="pt-6 border-t border-espresso/5 dark:border-white/5 grid grid-cols-2 gap-4">
                            <div>
                                <p className="text-[10px] uppercase font-bold text-espresso/40 dark:text-ivory/40">
                                    Monthly Sovereign
                                </p>
                                <p className="text-2xl font-black text-espresso dark:text-ivory">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-black text-terracotta dark:text-gold">
                                    ₹{healthInvestment.toLocaleString()}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-espresso dark:bg-midnight p-8 md:p-16 rounded-[4rem] text-center space-y-10 relative overflow-hidden">
                    <div className="relative z-10 space-y-4">
                        <p className="text-creme/60 dark:text-ivory/60 text-sm">
                            For less than the price of a fancy coffee per day, you secure the
                            insulin sensitivity, bone density, and gut health of your entire family.
                        </p>
                        <div className="py-8">
                            <div className="text-5xl md:text-7xl font-serif font-bold text-terracotta">
                                Worth It.
                            </div>
                        </div>
                        <Button
                            ...
                            size="lg"
                            className="bg-creme text-espresso hover:bg-white transition-all w-full md:w-auto"
                        >

...
const testimonials = [
    {
        ...
        role: "Gomti Nagar",
        content:
            "We stopped getting 'Mother Dairy' because my daughter's skin issues vanished within a month of switching to Amrit Gir Milk. The taste is nostalgic.",
        stars: 5,
    },
    {
        ...
        role: "Hazratganj",
        content:
            "The Ghee is exactly like what we used to have at our village. Grainy texture, nutty aroma. Truly the gold standard of Bilona.",
        stars: 5,
    },
    {
        name: "Dr. S. K. Gupta",
        role: "Indira Nagar",
        content:
            "Being a doctor, I analyze the cold chain. Amrit is the only service in Lucknow that genuinely maintains 4°C from farm to fridge.",
        stars: 5,
    },
];
            ...
            <div className="space-y-16">
                <div className="text-center space-y-4">
                    ...
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-espresso dark:text-ivory">
                        Wall of <span className="text-terracotta">Love.</span>
                    </h2>
                </div>
                    ...
                    {testimonials.map((t, i) => (
                        ...
                        >
                            ...
                            <div className="pt-6 border-t border-espresso/5 dark:border-white/5">
                                <h4 className="font-bold text-espresso dark:text-ivory">
                                    {t.name}
                                </h4>
                                <p className="text-xs uppercase tracking-widest text-terracotta/60 dark:text-gold/60">
                                    {t.role}
                                </p>
                            </div>
                        </motion.div>

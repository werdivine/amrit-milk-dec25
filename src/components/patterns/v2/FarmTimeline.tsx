...
const milestones = [
    {
        ...
        description:
            "Started with just 5 Gir cows and a passion to fix the broken milk system for my own children.",
        icon: Heart,
        color: "bg-rose-500",
        side: "left",
    },
    {
        ...
        description:
            "Implemented zero-waste systems. Lonapur village became our home and sanctuary for indigenous cows.",
        icon: Leaf,
        color: "bg-green-500",
        side: "right",
    },
    {
        ...
        description:
            "Reached 5,000+ families. Introduced authentic Bilona Ghee and cold-pressed oils.",
        icon: Users,
        color: "bg-blue-500",
        side: "left",
    },
    {
        ...
        title: "The Movement",
        description:
            "Now serving 20k+ families. Reclaiming our biological heritage through every bottle of pure Amrit.",
        icon: Award,
        color: "bg-gold",
        side: "right",
    },
        ...
        <Section className="bg-creme/50 dark:bg-midnight py-32 md:py-48 overflow-hidden">
            <div className="container mx-auto px-4">
                <div className="text-center mb-32">
                    ...
                    >
                        <Calendar className="w-3.5 h-3.5" />A Decade of Purity
                    </motion.div>
                    <motion.h2
                    ...
                    >
                        Our Journey <br />{" "}
                        <span className="text-terracotta dark:text-gold italic">Since 2015</span>
                    </motion.h2>
                    <div className="flex flex-col items-center gap-6">
                        <p className="text-xl md:text-2xl text-espresso/60 dark:text-ivory/60 max-w-2xl mx-auto font-medium">
                            It didn&apos;t start as a business. It started as a father&apos;s quest
                            for truth in food.
                        </p>
                                ...
                                >
                                    ...
                                    >
                                        <div className="bg-white dark:bg-midnight-mid p-10 md:p-14 rounded-[3.5rem] shadow-2xl border border-espresso/5 dark:border-white/5 relative group hover:border-terracotta/30 dark:hover:border-gold/30 transition-all duration-500">
                                            ...
                                            >
                                                <div
                                                    className={`w-14 h-14 rounded-2xl ${milestone.color} text-white flex items-center justify-center shadow-lg transform -rotate-6 group-hover:rotate-0 transition-transform duration-500`}
                                                >

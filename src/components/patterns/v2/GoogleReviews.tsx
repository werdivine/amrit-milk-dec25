                ...
                <div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="px-2 py-0.5 bg-green-500/10 rounded-full">
                            <span className="text-green-600 dark:text-green-400 text-[9px] font-black uppercase tracking-widest">
                                Verified Purchase
                            </span>
                        </div>
                    </div>
        ...
        <Section className="bg-[#FDFBF7] dark:bg-midnight py-32 border-t border-espresso/5 dark:border-white/5 overflow-hidden">
            <div className="container mx-auto px-4 mb-24">
                <div className="text-center">
                    ...
                    <p className="text-xl text-espresso/60 dark:text-ivory/60 max-w-2xl mx-auto leading-relaxed">
                        Authentic experiences from real families who have made Amrit Milk a part of
                        their daily rituals.
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <a
                    ...
                    className="text-espresso dark:text-ivory text-lg font-bold hover:text-blue-500 transition-colors flex items-center gap-2 border-b-2 border-blue-500/20 hover:border-blue-500 pb-1"
                >
                    View all reviews on Google Maps <ExternalLink className="w-5 h-5" />
                </a>
            </motion.div>
        </Section>
    );

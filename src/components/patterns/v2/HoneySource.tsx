...
import { Mountain, Sun, Trees } from "lucide-react";
        ...
        <Section className="bg-creme-dark dark:bg-midnight-mid py-20 border-y border-espresso/5 dark:border-white/5">
            <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-lg text-espresso/70 dark:text-ivory/70 max-w-3xl mx-auto mb-16 leading-relaxed">
                    Our honey isn&apos;t farmed; it&apos;s hunted. Sourced by indigenous tribal
                    communities from deep within the forests, ensuring the bees forage on wild
                    medicinal flora, not sugar syrup.
                </p>
                    ...
                    {[
                        {
                            ...
                            desc: "Collected from deep, pollution-free forests.",
                        },
                        {
                            icon: Sun,
                            title: "Raw & Unheated",
                            desc: "Bottled directly without heating or pasteurization.",
                        },
                        {
                            icon: Mountain,
                            title: "Tribal Sourced",
                            desc: "Empowering indigenous communities ethically.",
                        },
                    ].map((item, i) => (
                        <div
                            key={i}
                            className="flex flex-col items-center bg-white dark:bg-midnight p-8 rounded-2xl shadow-sm hover:shadow-md transition-all"
                        >

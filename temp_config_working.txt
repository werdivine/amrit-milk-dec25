                ...
                headers: [
                    ...
                    // Content Security Policy
                    {
                        ...
                        value: [
                            ...
                            "font-src 'self'",
                            "connect-src 'self' https://*.sanity.io https://*.sanity.api https://www.google-analytics.com https://region1.google-analytics.com",
                            "media-src 'self'",
                            "frame-src 'self' https://wa.me https://secure.ccavenue.com https://test.ccavenue.com",
                            "object-src 'none'",
                            "base-uri 'self'",
                            "form-action 'self' https://secure.ccavenue.com https://test.ccavenue.com",
